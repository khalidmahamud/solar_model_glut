...
GLuint planetTextures[9]; // Array to store texture IDs for each planet
GLUquadric *quad;

void loadTextures() {
    // Load textures for each planet
    planetTextures[0] = SOIL_load_OGL_texture("textures/mercury_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
    planetTextures[1] = SOIL_load_OGL_texture("textures/venus_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
    planetTextures[2] = SOIL_load_OGL_texture("textures/earth_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
    planetTextures[3] = SOIL_load_OGL_texture("textures/mars_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
    planetTextures[4] = SOIL_load_OGL_texture("textures/jupiter_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
    planetTextures[5] = SOIL_load_OGL_texture("textures/saturn_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
    planetTextures[6] = SOIL_load_OGL_texture("textures/uranus_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
    planetTextures[7] = SOIL_load_OGL_texture("textures/neptune_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
    planetTextures[8] = SOIL_load_OGL_texture("textures/sun_texture.jpg", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
}
...
Planet sun = { 8, 0.5, 0, 0.0, 0.0 }; // The sun doesn't move
...
void init(void) {
    ...
    glLoadIdentity();
    glFrustum(-1 * aspectRatio, 1 * aspectRatio, -1, 1, 2, 15);
...
void drawPlanet(Planet planet, GLfloat angle, GLfloat rotationAngle) {
    ...
    glBindTexture(GL_TEXTURE_2D, planetTextures[planet.id]); // Bind the texture for the current planet
